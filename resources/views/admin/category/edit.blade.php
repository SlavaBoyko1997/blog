                    ...
                    <div class="col-12">
                        <form action="{{route('admin.category.update',$category->id)}}" method="POST" class="w-25">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="title" placeholder="Категорія" value="{{$category->title}}">
                                @error('title')
                                    <div class="text-danger">Поле категорії не повинне бути пустим</div>
                                @enderror
                            </div>
